...
if not training and not retrain:
    X = np.loadtxt('../data/ckc2d_10_samples_noJL_short.db')
else:
...
# Network Parameters
num_encoded = 7
hidden_layers = [13]*2#[3,3,3,3,3,3,3,3, num_encoded]
...
load_from = 'model_10bars_1.ckpt'
save_to = 'model_10bars_1.ckpt'
    ...
    if training:
        ...
        for i in range(1, num_steps+1):
            ...
            if i % display_step == 0 or i == 1:
                ...
                save_path = saver.save(sess, "./models/cp10.ckpt")
                COSTS.append(c)
                STEPS.append(i)
